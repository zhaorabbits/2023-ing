...
29. 什么情况下会丢失？（操作都是基于内存的，没有刷盘的时候宕机了，会丢失）?
...
46. 我要查全量的，写个分页？怎么优化分页？

47. 索引失效场景？

48. MySQL为什么不用跳表？跳表的原理？

49. MySQL范围查找并排序的详细过程？如果数据很大，内存很小怎么办？如果有limit呢？

50. MySQL一张表能存储多少数据？怎么计算的？

51. 聚合函数，口述统计学生的平均成绩sql？

52. 如果我的type是个枚举类型？索引如何优化？

53. Mysql表有哪些种类？有哪些字段类型？

54. 文件里面2亿个数，找到最大100个？

55. 系统的文件日志，几千万条，怎么找出出现最多的ip地址？
